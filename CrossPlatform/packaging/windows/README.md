...
commit SHAs. Qt itself is pinned to 6.8.3. `windows-2025-vs2026` supplies Visual
Studio, the Windows SDK/signing tools, and Inno Setup while satisfying the app's
Windows 11 build floor. The workflow discovers their installed paths and fails
rather than downloading an unverified compiler.
